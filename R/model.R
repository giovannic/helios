...
#'   [generate_population_data()]. By default a new population is generated from `parameters_list`.
...
run_simulation <- function(
  ...
  # Generate the model variables (this is where the default population_data gets generated):
